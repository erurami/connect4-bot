...
int MinmaxABPlusDecider::Decide(
        ...
        int depth)
{
    ...
    {
        case 1:
            decision = minmaxABPlus(pGame, 0, MINMAX_MIN, -SINT32_INF, SINT32_INF);
            break;
        case 2:
            decision = minmaxABPlus(pGame, 0, MINMAX_MAX, -SINT32_INF, SINT32_INF);
            break;
    }
...
void MinmaxABPlusDecider::Kill(void)
{
#ifdef DEBUG
    printf("Kill called\n");
#endif
...
_MoveAndScore MinmaxABPlusDecider::minmaxABPlus(
        FourInARow::Game* pGame,
        ...
        int alpha, int beta)
{
    ...
    {
        best_move.score = -(m_depthToThink - depth + 1);
    }
    ...
    for (int i = 0; i < board_width; i++)
    {
        ...
        printf("%*cif move : %d\n", depth * 4, ' ', move);
#endif
        int next_score = minmaxABPlus(pGame, depth + 1, -minOrMax, alpha, beta).score;
